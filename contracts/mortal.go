...
const MortalABI = "[{\"constant\":false,\"inputs\":[{\"name\":\"_amt\",\"type\":\"uint256\"}],\"name\":\"withdrawAmount\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"withdraw\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"kill\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"owner\",\"outputs\":[{\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"}]"
...
func (_Mortal *MortalCaller) Owner(opts *bind.CallOpts) (common.Address, error) {
	...
	out := ret0
	err := _Mortal.contract.Call(opts, out, "owner")
	return *ret0, err
}
...
func (_Mortal *MortalSession) Owner() (common.Address, error) {
	return _Mortal.Contract.Owner(&_Mortal.CallOpts)
}
...
func (_Mortal *MortalTransactor) Withdraw(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Mortal.contract.Transact(opts, "withdraw")
}
...
func (_Mortal *MortalSession) Withdraw() (*types.Transaction, error) {
	return _Mortal.Contract.Withdraw(&_Mortal.TransactOpts)
}
...
func (_Mortal *MortalTransactor) WithdrawAmount(opts *bind.TransactOpts, _amt *big.Int) (*types.Transaction, error) {
	return _Mortal.contract.Transact(opts, "withdrawAmount", _amt)
}
...
func (_Mortal *MortalSession) WithdrawAmount(_amt *big.Int) (*types.Transaction, error) {
	return _Mortal.Contract.WithdrawAmount(&_Mortal.TransactOpts, _amt)
}
